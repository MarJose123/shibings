    ...
    return (
        <View className="container h-full justify-center bg-white items-center px-2">
            ...
            <View className="text-center gap-5">
                <Text className='text-3xl font-pextrabold text-center'>Kickstart Your Financial Journey</Text>
                <Text className='text-center text-lg'>A Step-by-Step Guide to Mastering Your Money Management with Ease</Text>
                <TouchableOpacity
                    activeOpacity={0.7}
                    ...
                    <View className='flex-row justify-between items-center'>
                        ...
                        <Icons.arrowRight className="stroke-1 h-4 w-4 stroke-white ml-5" fillClassName={'white'} />
                    </View>
                </TouchableOpacity>
            </View>
        </View>
